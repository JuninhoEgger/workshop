...
import static gui.util.Utils.tryParseToDouble;
import static gui.util.Utils.tryParseToInt;
...
public class SellerFormController implements Initializable {
    ...
    private Seller getFormData() {
        ...
        seller.setId(tryParseToInt(txtId.getText()));
        ...
        if (dpBirthDate.getValue() == null) {
            ...
            Instant instant = Instant.from(dpBirthDate.getValue().atStartOfDay(systemDefault()));
        ...
        seller.setBaseSalary(tryParseToDouble(txtBaseSalary.getText()));
    ...
    public void updateFormData() {
        ...
        if (entity.getBirthDate() != null) {
            dpBirthDate.setValue(LocalDate.ofInstant(entity.getBirthDate().toInstant(), systemDefault()));
        }
